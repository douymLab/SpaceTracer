...
def test_two_steps():
    ...
    config = LoadConfig().load_config(
        ...
        custom_config='/storage/douyanmeiLab/yangzhirui/SpaceTracer_new/P6_rep2_test_new_split_file/config.yaml'
#        custom_config='/storage/douyanmeiLab/yangzhirui/SpaceTracer_new/P6_rep1_test/config.yaml'
    ...
    results = pipeline.run() #only_steps=["mpileup"]
